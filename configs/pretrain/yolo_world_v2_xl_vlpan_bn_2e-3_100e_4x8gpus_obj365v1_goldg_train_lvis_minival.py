...
coco_val_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root="/home/rise/sdc2T/XJH/FEMA-Inspection/YOLO-World/data/coco/",
        test_mode=True,
        ann_file="lvis/lvis_v1_minival_inserted_image_name.json",
        data_prefix=dict(img=""),
        batch_shapes_cfg=None,
    ),
    class_text_path="/home/rise/sdc2T/XJH/FEMA-Inspection/YOLO-World/data/texts/lvis_v1_class_texts.json",
